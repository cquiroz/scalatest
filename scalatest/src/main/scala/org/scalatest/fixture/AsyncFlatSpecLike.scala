...
trait AsyncFlatSpecLike extends AsyncSuite with AsyncTestRegistration with ShouldVerb with MustVerb with CanVerb { thisSuite =>
  ...
  final def registerAsyncTest(testText: String, testTags: Tag*)(testFun: FixtureParam => Future[Assertion]) {
    ...
    engine.registerAsyncTest(testText, transformToOutcome(testFun), Resources.testCannotBeNestedInsideAnotherTest, "AsyncFlatSpecLike.scala", "registerAsyncTest", 4, stackDepthAdjustment, None, None, testTags: _*)
  }
  ...
  final def registerIgnoredAsyncTest(testText: String, testTags: Tag*)(testFun: FixtureParam => Future[Assertion]) {
    ...
    engine.registerIgnoredAsyncTest(testText, transformToOutcome(testFun), Resources.testCannotBeNestedInsideAnotherTest, "AsyncFlatSpecLike.scala", "registerIgnoredAsyncTest", 4, stackDepthAdjustment, None, testTags: _*)
  }
  ...
  final def registerTest(testText: String, testTags: Tag*)(testFun: FixtureParam => Any): Unit = {
    ...
    // SKIP-SCALATESTJS-END
    //SCALATESTJS-ONLY val stackDepthAdjustment = -4
    engine.registerAsyncTest(testText, FixtureParam => PastOutcome(OutcomeOf.outcomeOf(testFun)), Resources.testCannotBeNestedInsideAnotherTest, "AsyncFlatSpecLike.scala", "registerTest", 4, stackDepthAdjustment, None, None, testTags: _*)
  }
  ...
  final def registerIgnoredTest(testText: String, testTags: Tag*)(testFun: FixtureParam => Any): Unit = {
    ...
    // SKIP-SCALATESTJS-END
    //SCALATESTJS-ONLY val stackDepthAdjustment = -5
    engine.registerIgnoredAsyncTest(testText, FixtureParam => PastOutcome(OutcomeOf.outcomeOf(testFun)), Resources.testCannotBeNestedInsideAnotherTest, "AsyncFlatSpecLike.scala", "registerIgnoredTest", 4, stackDepthAdjustment, None, testTags: _*)
  }
