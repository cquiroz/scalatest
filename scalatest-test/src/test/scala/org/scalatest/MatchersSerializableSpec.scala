...
class MatchersSerializableSpec extends FunSpec {
  ...
  describe("Matchers") {
    ...
    it("a should be definedAt b should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should include regex (\"a(b*)c\" withGroup \"bb\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should include regex (\"a(b*)c\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should startWith regex (\"a(b*)c\" withGroup \"bb\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should startWith regex (\"a(b*)c\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should endWith regex (\"a(b*)c\" withGroup \"bb\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should endWith regex (\"a(b*)c\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should fullyMatch regex (\"a(b*)c\" withGroup \"bb\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
    ...
    it("a should fullyMatch regex (\"a(b*)c\") should product Serializable TestFailedException") {
      val e = intercept[TestFailedException] {
