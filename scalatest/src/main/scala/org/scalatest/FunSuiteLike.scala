...
trait FunSuiteLike extends Suite with TestRegistration with Informing with Notifying with Alerting with Documenting { thisSuite =>
  ...
  final def registerTest(testText: String, testTags: Tag*)(testFun: => Any /* Assertion */) {
    ...
    engine.registerTest(testText, Transformer(limitTestTime(testFun)), Resources.testCannotBeNestedInsideAnotherTest, "FunSuite.scala", "registerTest", 4, stackDepthAdjustment, None, None, None, testTags: _*)
  }
  ...
  protected def test(testName: String, testTags: Tag*)(testFun: => Any /* Assertion */) {
    ...
    engine.registerTest(testName, Transformer(limitTestTime(testFun)), Resources.testCannotAppearInsideAnotherTest, "FunSuite.scala", "test", stackDepth, stackDepthAdjustment, None, None, None, testTags: _*)
  }
