...
/**
  ...
  * import anyvals._
  *
  * scala&gt; NonZeroLong(1L)
  * res0: org.scalactic.anyvals.NonZeroLong = NonZeroLong(1)
  *
  * scala&gt; NonZeroLong(0L)
  * &lt;console&gt;:14: error: NonZeroLong.apply can only be invoked on a non-zero (i != 0L) long literal, like NonZeroLong(42L).
  *               NonZeroLong(0L)
  *                      ^
  * </pre>
  *
  ...
  *
  * scala&gt; NonZeroLong(x)
  * &lt;console&gt;:15: error: NonZeroLong.apply can only be invoked on an integer literal, like NonZeroLong(42L). Please use NonZeroLong.from instead.
  *               NonZeroLong(x)
  *                          ^
  * </pre>
  *
  ...
  * res3: Option[org.scalactic.anyvals.NonZeroLong] = Some(NonZeroLong(1))
  *
  * scala&gt; val y = 0L
  * y: Long = 0
  *
  ...
  *
  * scala&gt; invert(0L)
  * &lt;console&gt;:15: error: NonZeroLong.apply can only be invoked on a positive (i != 0L) integer literal, like NonZeroLong(42L).
  *               invert(0L)
  *                      ^
  *
  * </pre>
...
final class NonZeroLong private (val value: Long) extends AnyVal {
  ...
  /**
    ...
    */
  override def toString: String = s"NonZeroLong($value)"
  ...
  // No point to call abs on a NonZeroLong.
  /**
  ...
  /**
    ...
    * is greater than <code>0L</code>, it will return a <code>NonZeroLong</code> representing that value.
    ...
    *     to the passed function, wrapped in a <code>NonZeroLong</code> if it is positive (else throws <code>AssertionError</code>).
  ...
  def ensuringValid(f: Long => Long): NonZeroLong = {
    ...
    else throw new AssertionError(s"$candidateResult, the result of applying the passed function to $value, was not a valid NonZeroLong")
  }
}
...
object NonZeroLong {
  ...
  /**
    ...
    * than 0, it will return a <code>NonZeroLong</code> representing that value,
    ...
    *     <code>Some[NonZeroLong]</code>, if it is positive, else
    *     <code>None</code>.
    */
  ...
  /**
    ...
    * @return the specified <code>Long</code> value wrapped in a
    *     <code>NonZeroLong</code>, if it is positive, else
  ...
  if (NonZeroLongMacro.isValid(value)) new NonZeroLong(value) else {
    throw new AssertionError(s"$value was not a valid NonZeroLong")
  }
  ...
  /**
    ...
    * This method will inspect the passed <code>Long</code> value and if
    * it is a positive <code>Long</code>, <em>i.e.</em>, a value greater
    * than 0.0, it will return a <code>NonZeroLong</code> representing that value.
    ...
    * @return the specified <code>Long</code> value wrapped in a
    *     <code>NonZeroLong</code>, if it is positive, else the
  ...
  /**
    ...
    * a <code>NonZeroLong</code> representing that value.  Otherwise,
  ...
  /**
    ...
    * <code>Long</code>.
    *
    * @param non0 the <code>NonZeroLong</code> to widen
    * @return the <code>Long</code> value underlying the specified
    *     <code>NonZeroLong</code>.
    */
  implicit def widenToLong(non0: NonZeroLong): Long = non0.value
  ...
  /**
    ...
    */
  implicit def widenToFloat(non0: NonZeroLong): Float = non0.value
  ...
  /**
    ...
    */
  implicit def widenToDouble(non0: NonZeroLong): Double = non0.value
